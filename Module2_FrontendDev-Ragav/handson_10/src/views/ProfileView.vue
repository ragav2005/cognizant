...
const { enrolledCourses, totalCredits, isEnrolled } = storeToRefs(store)
</script>
...
<template>
  <section class="profile">
    ...
    <ul v-if="enrolledCourses.length">
    ...
    <p class="summary">Total credits: {{ totalCredits }}</p>
    <button type="button" @click="store.$reset()">Reset Profile</button>
